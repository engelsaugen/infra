...
Setup (currently) also assumes that you have argocd as only the app is included
...
Most of the stuff is insturcted to go into different dirs in /opt but mainly observability
